...
1. If you are on kali linux sqlmap is pre-installed. Otherwise you have to install it for yourself. Let's start with downloading sqlmap - you can do so from here - https://github.com/sqlmapproject/sqlmap
...
We'd use the "--data" flag to add a data to the POST request.
...
Next I ran the Gobuster tool to find any available directories. I found <i>/blood</i>.
...
We find the DB to be <i>blood</i>
...
After deploying the machine we visit its ip by <b> MACHINE_IP:80</b>
